  ...
  <div class="main"
      ...
      <div class="main-header">
        ...
        <div class="header-avator-con">
          ...
          <Button type="primary"
            ...
            {{$t('lang .xzdyj')}}</Button>
          <div style="width: 80px;display: inline-block;vertical-align: -webkit-baseline-middle;margin-left: 20px;">
          ...
          <div class="user-dropdown-menu-con"
            ...
            <Row style="margin-righ:10px">
              <Dropdown transfer
                ...
                <DropdownMenu slot="list">
                  <DropdownItem name="ownSpace">{{$t('lang .grzx')}}</DropdownItem>
                  <DropdownItem name="deptSwitch"
                                v-if="deptSwitchShow">{{$t('lang .qhks')}}</DropdownItem>
                  <DropdownItem name="loginout">{{$t('lang .qhyh')}}</DropdownItem>
                  <DropdownItem name="updataLog"
                                divided>{{$t('lang .gxrz')}}</DropdownItem>
                </DropdownMenu>
              </Dropdown>
    ...
    <div class="single-page-con"
      ...
      <div class="single-page"
           style="height:100%;margin:0;position:relative;padding: 30px 20px">
